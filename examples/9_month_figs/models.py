...
from dustdevol.generic import (
    ...
    fp_zeros,
    TF01,
    KA18_high_gpr_ejecta_lin,
    LC18_R150_ejecta,
    KA18_high_gpr_lin,
    LC18_R150_metals,
    AGB_SN_yields,
    LN2018_lin,
    rotating_lifetimes_gpr_lin,
    S2020,
)
...
gas_yields = AGB_SN_yields(KA18_high_gpr_ejecta_lin, LC18_R150_ejecta, None)
metal_yields = AGB_SN_yields(KA18_high_gpr_lin, LC18_R150_metals, 4)
...
reference = {
    ...
    "model_params": {
        ...
        "stellar_lifetimes": rotating_lifetimes_gpr_lin,
        "dust_yields": TF01,
